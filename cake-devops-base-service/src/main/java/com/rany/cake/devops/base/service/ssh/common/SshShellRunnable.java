...
import com.rany.cake.devops.base.service.ssh.SshShellCommandFactory;
import com.rany.cake.devops.base.service.ssh.SshShellProperties;
import com.rany.cake.devops.base.service.ssh.auth.SshAuthentication;
import com.rany.cake.devops.base.service.ssh.auth.SshShellAuthenticationProvider;
import com.rany.cake.devops.base.service.ssh.listener.SshShellListenerService;
import com.rany.cake.devops.base.service.utils.ChannelShellUtil;
import com.rany.cake.devops.base.service.utils.SshShellUtils;
    ...
    public void run() {
        ...
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            try {
                ...
                resultHandler.handleResult(baos.toString("UTF-8"));
                ...
                Object authenticationObject = session.getSession().getIoSession().getAttribute(SshShellAuthenticationProvider.AUTHENTICATION_ATTRIBUTE);
