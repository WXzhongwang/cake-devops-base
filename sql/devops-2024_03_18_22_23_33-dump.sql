...
CREATE TABLE `host` (
  ...
  `key_id` varchar(255) DEFAULT NULL COMMENT '秘钥ID',
  `status` char(4) DEFAULT '0',
  `is_deleted` char(4) DEFAULT '0',
  `gmt_create` datetime DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `host` VALUES (1,'1','测试机器1','v-local-test01','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(2,'2','测试机器2','v-local-test02','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(3,'3','测试机器3','v-local-test03','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(4,'4','测试机器4','v-local-test04','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(5,'5','测试机器5','v-local-test05','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(6,'6','测试机器6','v-local-test06','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(7,'7','测试机器7','v-local-test07','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(8,'8','测试机器8','v-local-test08','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(9,'9','测试机器9','v-local-test09','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(10,'10','测试机器10','v-local-test10','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(11,'11','测试机器11','v-local-test11','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(12,'12','测试机器12','v-local-test12','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(13,'13','测试机器13','v-local-test13','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(14,'14','测试机器14','v-local-test14','127.0.0.1',22,NULL,'yuanjinxiu','131400',NULL,NULL,'0','0','2023-11-23 21:40:54','2024-01-08 08:56:22','本机','1',NULL,NULL),(15,'903920328227565568','1','1','1',1,NULL,'1','1',NULL,NULL,'0','0','2024-01-07 18:23:31','2024-01-07 18:24:09','本机','1',NULL,NULL),(16,'903926807307366400','2','2','2222',2,NULL,'2','2',NULL,NULL,'0','0','2024-01-07 18:49:15','2024-01-07 18:49:15',NULL,NULL,NULL,NULL);
...
CREATE TABLE `server_key` (
  ...
  `modifier` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='机器秘钥';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `server_key` VALUES (1,'aaa','0','SSH','1','666',NULL,NULL,'0','2024-01-27 17:48:44','2024-01-27 17:54:56',NULL,NULL),(2,'kkkkfff','0','SSH','1','444',NULL,NULL,'0','2024-01-27 17:54:42','2024-01-27 17:54:46',NULL,NULL),(3,'kkkkfff','0','SSH','1','222',NULL,NULL,'0','2024-01-27 17:54:50','2024-01-27 17:54:52',NULL,NULL);
...
CREATE TABLE `server_proxy` (
  ...
  `gmt_modified` datetime(4) DEFAULT CURRENT_TIMESTAMP(4) ON UPDATE CURRENT_TIMESTAMP(4) COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='机器代理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统环境变量';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `webhook_config` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin ROW_FORMAT=DYNAMIC COMMENT='webhook 配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-03-18 22:23:34
