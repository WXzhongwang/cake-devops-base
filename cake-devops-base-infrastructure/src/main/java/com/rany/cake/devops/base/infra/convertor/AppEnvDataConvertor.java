...
public interface AppEnvDataConvertor extends BaseConvertor<AppEnv, AppEnvPO> {
    ...
    @Mapping(expression = "java(this.convertMapToString(appEnv.getEnvVars()))", target = "envVars")
    @Mapping(expression = "java(this.convertMapToString(appEnv.getSecretMap()))", target = "secretMap")
    ...
    @Mapping(target = "envVars", expression = "java(this.convertStringToMap(appEnvPO.getEnvVars()))")
    @Mapping(target = "secretMap", expression = "java(this.convertStringToMap(appEnvPO.getSecretMap()))")
