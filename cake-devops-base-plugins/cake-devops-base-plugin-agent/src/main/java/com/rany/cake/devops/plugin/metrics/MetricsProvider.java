package com.rany.cake.devops.plugin.metrics;

import com.rany.cake.devops.plugin.entity.dto.*;
import com.rany.cake.devops.plugin.entity.vo.DiskNameVO;
...
public class MetricsProvider {
    ...
    public OsInfoDTO getOsInfo() {
        ...
        info.setUsername(SystemUtils.USER_NAME);
